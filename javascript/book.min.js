...
this.getRightWidth()}};window.templeteName="popular";
window.templateArea={getLeftWidth:function(){return 0},getRightWidth:function(){return 0},getTopHeight:function(){return NeatStyle.isNeat()||!bookConfig.ToolBarVisible?0:isPC()?52:phoneTemplateArea.getTopHeight()},getBottomHeight:function(){return NeatStyle.isNeat()?40:bookConfig.ToolBarVisible?isPC()?window.thumbnail&&window.thumbnail.visible?thumbnail.getBottomHeight()+58:58:phoneTemplateArea.getBottomHeight():0},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+
this.getRightWidth()}};/*
